...
public class DeleteCheckDc implements Constants{
    ...
    public interface OnClickListener {
        void onClick(List<Record> callRecordItemList);
    }

    public static void showDeleteCheckCallConfirmDialog(final Context context, final List<Record> callRecordItemList, OnClickListener onClick) {
        mOnClick = onClick;
