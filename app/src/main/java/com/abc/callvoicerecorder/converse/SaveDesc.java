...
public class SaveDesc implements Constants{
    private static View view;
    private static MainActivity mainActivity;

    public static void showSaveDescConfirmDialog(final Context context, final CallRecord callRecordItem, final String descTitle, final String descBody) {
    ...
    private static void saveDesc(Context context, CallRecord callRecordItem, String descTitle, String descBody) {
        try {
            callRecordItem.setDescTitle(descTitle);
            callRecordItem.setDesc(descBody);
            try {
