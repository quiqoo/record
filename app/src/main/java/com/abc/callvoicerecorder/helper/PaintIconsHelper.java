...
public class PaintIconsHelper implements ConstantsColor {
    ...
    public static void setIconsColors(Context context, View view, int imgId, int resIconId) {
        ...
        if (img != null) {
            ...
            if (itemIcon != null) {
                itemIcon.setColorFilter(context.getResources().getColor(COLOR_ICONS[SharedPreferencesFile.getThemeNumber()]), PorterDuff.Mode.SRC_ATOP);
            }
    ...
    public static void setIconsColorsNew(Context context, ImageView imgView, int resIconId, int colorId) {
